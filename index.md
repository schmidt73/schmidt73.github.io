...
Currently, my research employs techniques from combinatorial
and convex optimization to study problems in biology and machine learning. 
For example, I applied linear and convex optimization techniques to
...
More recently, I have applied similar tools to design approximation
algorithms for [low-rank optimal transport](https://openreview.net/pdf?id=YKTJJCNXF4).
